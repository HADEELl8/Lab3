...
Alpha indicates the opacity of the geom.  Alpha values range from 0 to 1, with lower values corresponding to more transparent colors.

 Alpha can also be adjusted by color or aesthetic fill aesthetic if either aesthetic provides color values using an rgb specification ("#RRGGBBAA"), where AA refers to transparency values
